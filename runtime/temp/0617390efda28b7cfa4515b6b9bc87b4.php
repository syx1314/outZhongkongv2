<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:100:"E:\phpCode\zhongkong\outZhongkongv2\outZhongkongv2\public/../application/agent/view/admin/index.html";i:1631981505;}*/ ?>
<!-- 廖强 dayuanren@qq.com     -->
<!DOCTYPE html>
<html>
<head>
                ...
                <li class="nav-header">
                    <div class="dropdown profile-element">
                        ...
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                <span class="clear">
                               <span class="block m-t-xs"><strong class="font-bold"><?php echo $user['username']; ?></strong></span></span>
                        </a>
                    </div>
