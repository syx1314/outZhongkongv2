...
class Index extends Admin
{
    public function index()
    {
        ...
        $data['cus_num'] = M('customer')->where(['type' => 1])->count();
        $data['agent_num'] = M('customer')->where(['type' => 2])->count();
        $data['cus_balance'] = M('customer')->where(['type' => 1])->sum('balance');
        $data['agent_balance'] = M('customer')->where(['type' => 2])->sum('balance');
